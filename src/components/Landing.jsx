...
const Landing = () => {
  ...
  return (
    <div className="flex flex-col items-center w-full h-screen lg:h-full text-white gradientBG relative overflow-hidden">
      <motion.img
        src={MACAU}
        alt="MACAU"
        className="mt-[2.875rem] lg:mt-[5.3125rem]"
        variants={fadeInToUp}
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true }}
